# Vaultix AI Claude Code Context Document
...
vaultixai is a SaaS web application that connects to a customer's AWS
...
- This project was born from the Cloud Cost Toolkit (open source):
  github.com/issacguerrero67-web/vaultixai 
...
- Stripe
- Products: Pro      $49/mo  — 14-day free trial, then $49/mo
                     3 accounts, full reports, email alerts
  Team     $99/mo  — 14-day free trial, then $99/mo  
                     Unlimited accounts, Slack, priority support
  Manual Audit $300 — Done-for-you by Issac
                      AI-assisted, delivered in 24-48 hours
                      Book at calendly.com/issacguerrero67/aws-audit-call
